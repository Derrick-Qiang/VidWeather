...
SCENE_PATH="${SCENE_PATH:-data/test/derain/1}"
OUTPUT_ROOT="${OUTPUT_ROOT:-output/1}"
LOG_ROOT="${LOG_ROOT:-${OUTPUT_ROOT}/logs}"
FINAL_OUTPUT="${FINAL_OUTPUT:-${OUTPUT_ROOT}}"

PRIOR_CKPT="${PRIOR_CKPT:-AdaIR/vp_adair_partial_trustsup_v1_e10/epoch=99-step=146000.ckpt}"
...
run_infer() {
  ...
  echo "Running scene 1 inference..."
  ...
  echo "Final result saved to: ${FINAL_OUTPUT}/derain/1"
}
