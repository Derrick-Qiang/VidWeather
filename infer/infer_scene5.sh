...
SCENE_PATH="${SCENE_PATH:-data/test/derain/5}"
OUTPUT_ROOT="${OUTPUT_ROOT:-output/5}"
...
run_infer() {
  ...
  echo "Running scene 5 inference..."
  ...
  echo "Final result saved to: ${FINAL_OUTPUT}/derain/5"
}
